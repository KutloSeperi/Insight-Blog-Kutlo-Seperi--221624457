...
<?php endif; ?>
        ...
        <h2 class="text-2xl font-bold mb-6 text-center text-gray-700 dark:text-gray-200"><?php echo e(__('Login')); ?></h2>
        ...
        <form method="POST" action="<?php echo e(route('login')); ?>">
            ...
            <!-- Email Address -->
            <div class="mb-4">
                <label for="email" class="block text-gray-700 text-sm font-bold mb-2 dark:text-gray-300"><?php echo e(__('Email')); ?></label>
...
<?php endif; ?>
            ...
            <!-- Password -->
            <div class="mb-4">
                <label for="password" class="block text-gray-700 text-sm font-bold mb-2 dark:text-gray-300"><?php echo e(__('Password')); ?></label>
...
<?php endif; ?>
            ...
            <div class="flex items-center justify-between">
                ...
                <?php if(Route::has('password.request')): ?>
                    <a class="text-sm text-indigo-500 hover:text-indigo-700 dark:text-indigo-400" href="<?php echo e(route('password.request')); ?>">
...
<?php endif; ?>
<?php /**PATH C:\Users\kutlo\OneDrive\Desktop\final\app\resources\views/auth/login.blade.php ENDPATH**/ ?>